...
export default function BrandHeroSection() {
  return (
    <section className="bg-white px-6 pb-16 text-center sm:px-10 lg:px-16">
      ...
      <MeshGradientPanel className="mx-auto mt-16 flex w-full max-w-5xl items-center justify-center py-24">
        <BrandCardVisual />
      </MeshGradientPanel>
    </section>
  );
