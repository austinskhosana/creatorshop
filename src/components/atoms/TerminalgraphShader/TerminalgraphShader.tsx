// @terminalgraph · OpenShaders (https://openshaders.com/@terminalgraph) · WebGL2 dither shader
...
const float HUE = 0.3944;
const float HUE_SPREAD = -0.045;
const float HUE_TRAVEL = 2.4902482;
const float CHROMA = 0.12;
const float LIGHTNESS = 0.68;
const float COLOUR_CYCLE = 0.218910113;
const float THETA = 2.1396265;
const float SHEAR = 0.967764676;
const float SHRINK = 0.959008038;
const float LAYERS = 86.0;
const float WARP_FREQ_X = 0.444605738;
const float WARP_FREQ_Y = 2.56047916;
const float WARP_AMP_X = 0.136415765;
const float WARP_AMP_Y = 0.0338266231;
const float ASPECT_X = 2.4244864;
const float ASPECT_Y = 0.194405332;
const float OFFSET_X = 0.344900906;
const float OFFSET_Y = -0.00240111328;
const float TILT = -2.8612771;
const float ZOOM = 0.986010015;
const float CENTRE_X = 0.398617059;
const float CENTRE_Y = 0.493922979;
const float GLOW_SIZE = 0.00231170445;
const float FALLOFF = 0.458144099;
const float VIGNETTE = 0.043874044;
const float FLOW_SPEED = 0.615633965;
const float FLOW_DIRECTION = -1.0;
const float BREATH_RATE = 0.39990589;
const float BREATH_AMOUNT = 0.109075725;
const float PHASE = 56.8769302;
const float ECHO = 0.318303347;
const float ECHO_SHIFT = -0.172858253;
const float SOFTNESS = 0.00215061265;
const float LIGHT_SWING = 0.231474072;
...
const float uStrength = 1.06609535;
const float uScale = 0.840933144;
const float uSeed = 0.0983454809;
...
export type TerminalgraphShaderProps = {
  theme?: ShaderTheme;
  background?: { dark?: string; light?: string };
  time?: number;
  onError?: (error: Error) => void;
...
export function TerminalgraphShader({ theme = "dark", background, time, onError, className, style }: TerminalgraphShaderProps) {
